...
import { Card, CardHeader, CardBody, Divider, Chip, Button, Link } from "@heroui/react";
                ...
                <div className="w-full max-w-6xl flex flex-col gap-24">
                    ...
                    <section className="relative flex flex-col items-center text-center gap-6 pt-16 pb-12 overflow-hidden rounded-3xl bg-white border border-slate-100 shadow-sm">
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-6">
                            <Chip color="warning" variant="flat" size="sm" className="uppercase tracking-widest font-bold text-[10px]">
                                Public Beta
                            </Chip>
                    ...
                    <section>
                        <div className="grid lg:grid-cols-2 gap-20 items-center">
                            ...
                            <Card className="border-none shadow-2xl bg-white overflow-hidden" radius="lg">
                                <Image
                    ...
                    <section className="flex flex-col gap-10 py-8">
                        <div className="text-center space-y-3">
                            ...
                            <p className="text-base text-slate-500 max-w-2xl mx-auto">
                                The builders behind the platform, combining expertise in AI, product design, and frontend engineering.
                            </p>
                        </div>
                    ...
                    <section className="bg-slate-900 rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-8 max-w-2xl mx-auto">
                            <Chip color="secondary" variant="shadow" className="uppercase tracking-widest font-bold text-[10px]">
                                Get In Touch
                            </Chip>
                            ...
                            <p className="text-lg text-slate-300 leading-relaxed">
                                We're currently in <strong>Public Beta</strong>. Your feedback is invaluable in helping us refine the platform.
                                Encountered a bug? Have a feature request? Let us know.
                            </p>
                            <div className="pt-4">
                                <Button
                                    size="lg"
...
function TeamMemberCard({ name, role, description, linkedinUrl }: { name: string, role: string, description: string, linkedinUrl?: string }) {
    return (
        <Card className="border-none shadow-md hover:shadow-xl transition-shadow duration-300 bg-white h-full" radius="lg">
            <CardHeader className="flex flex-row items-start justify-between px-6 pt-6 pb-2">
                <div className="flex flex-col gap-1">
                    <h3 className="text-xl font-bold text-slate-900">{name}</h3>
                    <span className="text-xs font-semibold text-blue-600 bg-blue-50 px-2 py-1 rounded-full w-fit">{role}</span>
                </div>
                {linkedinUrl && (
                    <Button
                        isIconOnly
